...
//zwracanie
Student * zwroc_studenta(Student *glowa, int i) 
{
...
Przedmiot * zwroc_przedmiot(Przedmiot *glowa, int i) 
{
...
Ocena * zwroc_ocene(Ocena *glowa, int i) 
{
    while (glowa != NULL && i-- > 0)
        glowa = glowa->nast;    
...
//wypisywanie według podanej kolejności
...
//sortowanie według tego co chcemy
...
Przedmiot * sortuj_przed_przez_wybrany_nazwa(Przedmiot *glowa) 
{
    Przedmiot * nglowa = NULL;
    Przedmiot * m;
    Przedmiot * o;
...
Ocena * filtruj_przedmioty(Ocena * glowa, char *kod, SBaza *baza) 
{
    Ocena *c = NULL;
    Ocena * n = NULL;
    ...
    {
        if(strcmp(glowa->kod_przedmiotu, kod)==0)
        { 
            Ocena * nowaglowa;
...
Ocena * filtruj_przedmioty2(Ocena * glowa, char *album, SBaza *baza) 
{
    Ocena *c = NULL;
    Ocena * n = NULL;
